        ...
        extends HiveProductTest
{
    ...
    public void testReadFullAcid(boolean isPartitioned, BucketingType bucketingType)
    {
        ...
        String tableName = "test_full_acid_table_read_" + randomTableSuffix();
    ...
    public void testReadInsertOnly(boolean isPartitioned, BucketingType bucketingType)
    {
        ...
        String tableName = "test_insert_only_table_read_" + randomTableSuffix();
        onHive().executeQuery("DROP TABLE IF EXISTS " + tableName);
    ...
    public void testFailAcidBeforeHive3()
    {
        ...
        String tableName = "test_fail_acid_before_hive_3_" + randomTableSuffix();
        onHive().executeQuery("" +
